...
const findOnePhotos = (request, response) => {
    return 0;
}
...
const formPhotos = async (request, response) => {
...
const savePhotos = async (request, response) => {
    ...
    const validationRules = [
        check('title').notEmpty().withMessage('The title is required').isLength({ min: 15, max: 150 }).withMessage('The title photo must have between 15 and 150 characters'),
